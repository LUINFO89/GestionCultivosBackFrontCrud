...
function VerGestionPredios() {
  ...
  const obtenerDatoP = async (idParametro) => {
    ...
    setUsuariogestion(respuesta.data.usuariogestion);
  ...
  const data = usuarios.map((usuarios) => ({
    ...
    usuariogestion: usuarios.usuariogestion,
  ...
  const actualizar = async (e) => {
    ...
    const respuesta = await Axios.put("/gestionpredios/actualizar/" + id, usuario, {
      headers: { autorizacion: token },
    });
    ...
    <div className="container">
      <MaterialTable
        ...
        columns={[
          ...
          { title: "usuariogestion", field: "usuariogestion" },
        ]}
        data={data}
        options={{
          search: true,
